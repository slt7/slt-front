							...
							<div class="articles">
								<div class="article">
									...
									<div class="article__img wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
										<img src="media/blog/blog4.jpg" alt="blog" class="img-responsive" />
									</div>
									...
									<h3 class="article-title wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">Lorem ipsum dolor sit amet consectetur </h3>
									<p class="blog-text blog-text--article wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">Nunc molestie sapien tempor placerat Cras et lectus. Etiam sit amet turpis. Suspendisse et erat. Ut  Proin a ipsum vitae orci por tristiqu nam. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim
										ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor reprehe nda
										it in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
									<p class="blog-text blog-text--article wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa qua
										eab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit spernat
										ur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est quidw dolorem ipsum quia dolor sit amet consectetur adipisci velit sed quia non numquam eius modi tempora incidunt ut labore et dolore mag nam aliquam quaerat voluptatem.</p>
									<h3 class="blog-title wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">How to build a good bike<span class="line line--title line--blog-title"><span class="line__first"></span><span class="line__second"></span></span></h3>
									<p class="blog-text wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
										Orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enimad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehender
										in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.
									</p>
									<div class="citation wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
										Proin blandit quam molestie luctus vehicula orci massa interdum justo nec rutrum risus augue utder nisl  ultric lacu at  Etiam eleifend nisl nec lectus aecenas sit amet donec erat. Fusce quis nisl ac sapie 
									</div>
									<p class="blog-text wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa qua
										eab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit spernat
										ur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est quidw dolorem ipsum quia dolor sit amet consectetur adipisci velit sed quia non.</p>
									<div class="article__imgs">
										<div class="row row--no-padding">
											<div class="col-xs-6 wow slideInLeft" data-wow-delay="0.7s" data-wow-duration="1.5s"><img alt="bike" class="img-responsive" src="media/blog/blog5.jpg" /></div>
											<div class="col-xs-6 wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s"><img alt="bike" class="img-responsive" src="media/blog/blog6.jpg" /></div>
										</div>
									</div>
									<p class="blog-text wow slideInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">Numquam eius modi tempora incidunt ut labore et dolore mag nam aliquam quaerat voluptatem. Lorem ipsum dolor sit amet, consectet adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
									...
									<div class="article-comments">
										...
										<div class="article-comments__group">
											<div class="article-comment clearfix wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
												...
												<div class="article-comment__author">
													<img class="img-responsive" alt="author" src="media/persons/user1.jpg" />
												</div>
												<div class="article-comment__body">
													<h2 class="article-comment__name">Mark Thomas</h2>
													<div class="article-comment__date">March 30, 2015</div>
													<p class="blog-text blog-text--article">Numquam eius modi tempora incidunt ut labore et dolore mag nam aliquam quaerat voluptatem. Lorem ipsum
														dolor sit amet consectet adipisicing elit sed do eiusmod tempor incididunt.</p>
												</div>
											</div>
											<div class="article-comment article-comment--to clearfix wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
												...
												<div class="article-comment__author">
													<img class="img-responsive" alt="author" src="media/persons/user2.jpg" />
												</div>
												<div class="article-comment__body">
													<h2 class="article-comment__name">Christopher Doe</h2>
													<div class="article-comment__date">March 30, 2015</div>
													<p class="blog-text blog-text--article">Numquam eius modi tempora incidunt ut labore et dolore mag nam aliquam quaerat voluptatem. Lorem ipsum
														dolor sit amet consectet adipisicing elit sed do eiusmod tempor incididunt.</p>
												</div>
										...
										<div class="article-comments__group wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
											<div class="article-comment clearfix">
												<a href="#" class="article-comment__action triangle triangle--12">
													<span class="fa fa-long-arrow-left"></span>
												</a>
												<div class="article-comment__author">
													<img class="img-responsive" alt="author" src="media/persons/user3.jpg" />
												</div>
												<div class="article-comment__body">
													<h2 class="article-comment__name">Angela Hill</h2>
													<div class="article-comment__date">March 30, 2015</div>
													<p class="blog-text blog-text--article">Numquam eius modi tempora incidunt ut labore et dolore mag nam aliquam quaerat voluptatem. Lorem ipsum
														dolor sit amet consectet adipisicing elit sed do eiusmod tempor incididunt.</p>
												</div>
