		...
		<section class="status status--shop dark-bg dark-bg--shop">
			<div class="container wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
				<div class="breadcumb">
					...
					<span class="breadcumb__del no-decoration">&raquo;</span>
					<a href="item.html" class="breadcumb__page no-decoration">Product info</a>
				</div>
				<h2 class="title title--page"><span class="title__bold">Universal</span> N-COM Kit</h2>
			</div>
		</section><!--status-->
					...
					<div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
								...
								<div class="col-md-6 col-xs-12">
									<div class="shop-item-desc">
										<header class="shop-item-desc__head wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
											<h1>Nolan Multi 2 Universal N-COM Kit</h1>
											<div class="clearfix">
										...
										<div class="shop-item-desc__body wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
											<p class="blog-text">Nunc molestie sapien tempor placerat Cras et lectus. Etiam sit amet turpis. Suspendisse et erat. Ut  Proin a ipsum vitae orci port tristiqu nam. Class aptent tacitid sociosqu luad sodales feugiat nulla. Lorem ipsum dolor sit amet consectetur adipisicing elit sed doner eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim denim veniam quis nostrud exercitation.</p>
								...
								<div class="col-md-6 col-xs-12">
									<div class="gallery wow fadeInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
										...
										<div class="gallery__small js-gall-pager">
											<a data-slide-index="0" href=""><img src="media/product-small/small1.jpg" alt="product" /></a>
						...
						<div class="aside-tabs aside-tabs--about aside-tabs--item wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
							<div class="aside-tabs__links">
								<a href="#" class="no-decoration aside-tabs__active-link js-tab-link" data-for="#desc">description</a>
								<a href="#" class="no-decoration js-tab-link" data-for="#rev">reviews (3)</a>
							</div>
							<div class="aside-tabs__blocks about-tab js-tab-block" id="desc">
								<p>The Multi2 Kit fits any Nolan helmet not equipped with SDS or RCS, or any other brand of helmet. The Multi2 Bluetooth Kit offers the same features as Nolan's regular B1 kits, but developed for helmets that are not N-Com ready. This kit is available as a single unit or as a set of two units. It is optimized for one rider or for a couple riding on one motorcycle, as the distance helmet to helmet is limited to 150 feet.</p>
								<p>Single unit.<br />
									Rider to passenger communication via Bluetooth.<br />
									Other devices can be connected to the Multi2: Music players and other devices using a standard headphone jack can be connected via a MultiMedia Wire (not included) and other Bluetooth-enabled devices such as a cell-phone and a GPS can be paired through the Bluetooth connection.<br />
									Limited warranty valid for 2 (two) years from the date of purchase. </p>
							</div>
